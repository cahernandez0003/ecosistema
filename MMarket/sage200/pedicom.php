...
<nav class="navbar navbar-expand-lg" style="background-color: hsl(220,100%,90%); position: fixed; z-index: 1; height: 65px; width: 100%;"><img src="../public/imgs/favicon.png" style="width: 55px; height: 55px; padding: 0px; margin: 20px;">
    ...
    <br>
                ...
                <h1 class="text-muted text-center"> PEDIDOS DE COMPRA </h1>
    <div class="container">            
        <div class="row">
            ...
            <div class="col-md-12 offset-md-0">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" placeholder="Buscar por Número Pedido" id="searchByNumeroPedido">
                    </div>
                </div>
                ...
                <table style="vertical-align: middle;" id="albvenTable" class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php $lstar = list_pedicom($con); ?>
                        <?php foreach ($lstar as $prow): ?>
                            <tr>
                                <td style="white-space: nowrap;"><?php echo date('Y-m-d', strtotime($prow['FechaPedido'])); ?></td>
                                <td><?php echo $prow['SeriePedido']; ?></td>
                                <td><?php echo $prow['NumeroPedido']; ?></td>
                                <td><?php echo $prow['CodigoProveedor']; ?></td>
                                <td><?php echo $prow['RazonSocial']; ?></td>
                                <td style="text-align: right"><?php echo number_format($prow['ImporteLiquido'],2,'.',''); ?>€</td>
                                <td><?php echo $prow['NumeroLineas']; ?></td>

                                <td><a href="showpedcom.php?SeriePedido=<?php echo $prow['SeriePedido']; ?>&NumeroPedido=<?php echo $prow['NumeroPedido']; ?>"><i class="fa fa-search"></i></a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    $(document).ready(function () {
        ...
        $('#searchByNumeroPedido').on('keyup', function() {
